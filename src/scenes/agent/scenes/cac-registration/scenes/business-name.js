...
import { CacReportForm as ReportCacFormReportCacForm } from "../../reports/cac-report/cac-reg-details/cacReport-form";
...
class BusinessNameDetails extends React.Component {
  ...
  componentDidMount() {
    const cacRegType = this.props.navigation.getParam("cacRegType");
